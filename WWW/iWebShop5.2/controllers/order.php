...
class Order extends IController implements adminAuthorization
{
	...
	public function delivery_show()
	{
	 	...
	 	if($delivery_id)
	 	{
	 		...
	 		$tb_delivery->fields = 'c.id as id,o.order_no,c.order_id,p.name as pname,o.create_time,u.username,c.name,c.province,c.city,c.area,c.address,c.mobile,c.telphone,c.postcode,c.freight,c.delivery_code,c.time,c.note,c.express_template';
	...
	public function expresswaybill_print()
	{
		...
		expresswaybill::batPrint($orderId);
	}
